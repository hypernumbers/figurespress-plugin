...
1. Upload `figurespress-plugin-1.1.zip` to the `/wp-content/plugins/` directory
1. Unzip it
1. Activate the plugin through the 'Plugins' menu in WordPress
1. Use the shortcode `[fp cells="a1:b16"]`
...
The plugin is hosted on [Github](https://github.com/hypernumbers/figurespress-plugin).

Feel free to post any problems on the [issues log](https://github.com/hypernumbers/figurespress-plugin/issues)
